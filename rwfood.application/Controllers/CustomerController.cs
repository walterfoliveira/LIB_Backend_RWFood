...
namespace rwfood.application.Controllers
{
    ...
    {
        readonly IServiceCustomer classeService;
        readonly string nameController;

        public CustomerController(IServiceCustomer _classeService, ILog _logger, IConfiguration _configuration) : base(_classeService, _logger, _configuration)
        {
